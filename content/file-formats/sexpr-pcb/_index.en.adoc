...
<7> The `layer` token defines the xref:../sexpr-intro/index.adoc#_canonical_layer_names[canonical layer]
    the text box resides on.
<8> The `tstamp` token defines the unique identifier of the text box.
<9> The `effects` token describes the xref:../sexpr-intro/index.adoc#_text_effects[text style] of the text 
    in the text box.
<10> The `stroke` token describes the xref:../sexpr-intro/index.adoc#_stroke_definition[stroke properties] 
     of an optional border to be drawn around the text box.
