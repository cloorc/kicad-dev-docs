...
<9> The xref:../sexpr-intro/index.adoc#_text_effects[TEXT_EFFECTS] describe the style of the text in the
    text box.
<10> The xref:../sexpr-intro/index.adoc#_stroke_definition[STROKE_DEFINITION] describes the style of an
