...
See the xref:../sexpr-intro/index.adoc#_footprint[footprint] in the s-expression common
...
common definitions.  This section will not exist if there are no graphics on the board.
