...
<1> The graphical items is a list of graphical <<_graphical_line,lines>>,
    ...
    the geometrical information that defines the item.  The text bounding box defines the location 
    and size of the pad number and netname.
...
=== Graphical Text Box (from version 7)
...
==== Annotation Bounding Box (from version 7)
