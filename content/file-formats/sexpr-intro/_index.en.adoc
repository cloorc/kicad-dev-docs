...
<8> The optional `descr` token defines a string containing the description of the footprint.
<9> The optional `tags` token defines a string of search tags for the footprint.
