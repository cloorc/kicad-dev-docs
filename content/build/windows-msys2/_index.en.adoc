...
NOTE: MSYS2 is the legacy build system for Windows due to KiCad's historical roots. KiCad has switched to MSVC for nightly builds for 6.0 and will release under 6.0. MSYS2 is still supported but your mileage may vary.
