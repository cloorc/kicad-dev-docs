...
Additionally, you'll need to make sure the optional component link:https://docs.microsoft.com/en-us/cpp/build/cmake-projects-in-visual-studio?view=msvc-160#installation[**C++ CMake tools for Windows**] is installed.
