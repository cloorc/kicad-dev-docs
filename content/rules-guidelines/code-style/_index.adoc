...
should not exceed 99 columns unless absolutely necessary. This prevents
...
== 5. License Statement
There is a file called copyright.h in which you can copy into the top of
...
If you need to leave debugging output on, future testing, use tracing
output (see 6.1).
